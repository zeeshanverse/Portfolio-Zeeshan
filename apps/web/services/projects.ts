...
const FALLBACK_PROJECT_DETAILS: Record<string, ProjectDetailResponse> = {
  'smart-attendance-system': {
    id: 'fallback-smart-attendance-system', slug: 'smart-attendance-system',
...
The project demonstrates a practical use of computer vision to reduce repetitive manual attendance work while keeping an organized record of attendance events.`,
    ...
    tagline: 'Final Year Project', role: 'Final Year Project · Python / Flask / Computer Vision',
    startedAt: '2025-01-01T00:00:00.000Z', endedAt: '2025-05-31T00:00:00.000Z',
    liveUrl: 'https://smart-attendance-system-tvmk.onrender.com/api/auth/demo', repoUrl: 'https://github.com/zeeshanverse/smart-attendance-system',
    featured: true, published: true, displayOrder: 0,
    createdAt: '2025-01-01T00:00:00.000Z', updatedAt: '2026-09-09T00:00:00.000Z',
    tags: [
      { id: 'python', slug: 'python', label: 'Python', color: null },
      { id: 'flask', slug: 'flask', label: 'Flask', color: null },
      { id: 'opencv', slug: 'opencv', label: 'OpenCV', color: null },
      { id: 'sqlite', slug: 'sqlite', label: 'SQLite', color: null },
    ], images: [],
  },
  mymeal: {
    id: 'fallback-mymeal', slug: 'mymeal', title: 'MyMeal',
...
MyMeal provided practical experience connecting frontend interactions with backend functionality and building a complete e-commerce-style application flow.`,
    ...
    tagline: null, role: 'Web Application · Flask / JavaScript', startedAt: '2024-01-01T00:00:00.000Z', endedAt: '2024-12-31T00:00:00.000Z',
    liveUrl: 'https://mymeal.onrender.com', repoUrl: 'https://github.com/zeeshanverse/project-E-commerce-Website-MyMeal-',
    featured: true, published: true, displayOrder: 1, createdAt: '2024-01-01T00:00:00.000Z', updatedAt: '2026-09-09T00:00:00.000Z',
    tags: [{ id: 'flask', slug: 'flask', label: 'Flask', color: null }, { id: 'javascript', slug: 'javascript', label: 'JavaScript', color: null }], images: [],
  },
  'banking-system': {
    id: 'fallback-banking-system', slug: 'banking-system', title: 'Banking System',
...
The backend is structured around Spring Boot REST APIs, JWT authentication and relational persistence. The project focuses on validation, secure request handling, database interaction and reliable transaction workflows.`,
    ...
    tagline: null, role: 'Java / Spring Boot · REST API', startedAt: '2026-01-01T00:00:00.000Z', endedAt: '2026-08-31T00:00:00.000Z',
    liveUrl: null, repoUrl: 'https://github.com/zeeshanverse/banking-system-springboot', featured: true, published: true, displayOrder: 2,
    createdAt: '2026-01-01T00:00:00.000Z', updatedAt: '2026-09-09T00:00:00.000Z',
    tags: [{ id: 'java', slug: 'java', label: 'Java', color: null }, { id: 'spring-boot', slug: 'spring-boot', label: 'Spring Boot', color: null }, { id: 'rest-api', slug: 'rest-api', label: 'REST API', color: null }, { id: 'sql', slug: 'sql', label: 'SQL', color: null }], images: [],
  },
  jobtrack: {
    id: 'fallback-jobtrack', slug: 'jobtrack', title: 'JobTrack',
...
[GitHub](https://github.com/zeeshanverse/job-tracker)`,
    ...
    tagline: 'Upcoming project · actively in progress', role: 'HTML / CSS / JavaScript', startedAt: '2026-01-01T00:00:00.000Z', endedAt: null,
    liveUrl: null, repoUrl: 'https://github.com/zeeshanverse/job-tracker', featured: false, published: true, displayOrder: 3,
    createdAt: '2026-01-01T00:00:00.000Z', updatedAt: '2026-09-09T00:00:00.000Z',
    tags: [{ id: 'html', slug: 'html', label: 'HTML', color: null }, { id: 'css', slug: 'css', label: 'CSS', color: null }, { id: 'javascript', slug: 'javascript', label: 'JavaScript', color: null }], images: [],
  },
}
...
export async function getProject(slug: string): Promise<ProjectDetailResponse | null> {
  try {
    ...
    if (!res.ok) return FALLBACK_PROJECT_DETAILS[slug] ?? null
...
export async function getFeaturedProjects(): Promise<ProjectDetailResponse[]> {
  try {
    const res = await api.get('/projects/featured', { cache: 'no-store' })
    if (!res.ok) return []
    return res.json() as Promise<ProjectDetailResponse[]>
  } catch {
    return []
...
export async function getAllProjectSlugs(): Promise<string[]> {
  ...
  return projects.length ? projects.map((p) => p.slug) : Object.keys(FALLBACK_PROJECT_DETAILS)
}
